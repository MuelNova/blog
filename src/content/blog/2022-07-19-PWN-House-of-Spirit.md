...
description: 本文向读者介绍了计算机安全领域中的一种利用技术：`House_of_spirit`，作者nova详细解析了这种技术如何通过在栈上构造伪造块（fake_chunk）来实现近乎任意的写入操作。关键点在于需要满足16字节对齐要求，以及伪造的下一个块的大小（next_fake_chunk
  size）来绕过检验。
pubDate: 2022-07-19
tags:
- CTF
...
![image-20220719220643524](https://cdn.nova.gal/img/image-20220719220643524.png)

![image-20220719220923354](https://cdn.nova.gal/img/image-20220719220923354.png)

# 实战

## lctf2016_pwn200

![checksec](https://cdn.nova.gal/img/image-20220719235857110.png)

保护啥也没开，想着就是直接`ret2shellcode`梭哈，但是没有那么多字节给我们栈溢出。

![400A8E](https://cdn.nova.gal/img/image-20220719235308594.png)
...
![fake_next_chunk_size](https://cdn.nova.gal/img/image-20220720001354338.png)
...
![image-20220720002739429](https://cdn.nova.gal/img/image-20220720002739429.png)
...
![image-20220720204517147](https://cdn.nova.gal/img/image-20220720204517147.png)
