---
title: Malloc的源码审计
description: 这篇博客文章主要由作者nova编写，详细分析了glibc库中malloc函数的实现及其可利用的漏洞点。
pubDate: 2022-06-30
tags:
- CTF
- Pwn
...
![32bytes_of_malloc(0)](https://cdn.nova.gal/img/image-20220519164757635.png)
...
![structure_of_the_first](https://cdn.nova.gal/img/image-20220519204208793.png)

首先第一次循环时，`pp = victim`, `victim = pp->fd`

![first_loop](https://cdn.nova.gal/img/image-20220519204410001.png)
...
![end_of_the_first_loop](https://cdn.nova.gal/img/image-20220519205349480.png)
...
![img](https://cdn.nova.gal/img/20210928234156-9c2ced00-2072-1.png)
