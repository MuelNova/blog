---
title: Linux下的动态链接机制
description: 文章主要介绍了Linux下动态链接机制的相关知识，阐明了静态链接与动态链接的区别以及各自的优缺点。
pubDate: 2022-01-13
tags:
- CTF
- Pwn
...
![the process of static linking](https://cdn.nova.gal/img/20180505235327609)
...
![the process of PLT and GOT](https://cdn.nova.gal/img/20170123155535419)
