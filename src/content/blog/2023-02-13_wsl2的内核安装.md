...
description: 博客作者 nova 记录了在使用 WSL2（Windows 子系统 Linux 2）时，如何更换内核的全过程。由于要开始学习 Kernel
  Pwn，nova 决定替换 WSL2 的默认内核。
pubDate: 2023-02-13
tags:
- wsl
- cheatsheet
...
![kernel_version](https://cdn.nova.gal/img/$EC7{D983~Q2$G_8U6FA{UG.png)
...
![image-20230213122206839](https://cdn.nova.gal/img/image-20230213122206839.png)
...
![image-20230213123158068](https://cdn.nova.gal/img/image-20230213123158068.png)
