---
title: 是的，我更换了昵称！
description: 作者 nova 花费了很长一段时间考虑是否要更换昵称，并详细描述了这一过程中各种名字和选择的思考。她提到，在过去几个月里尝试了如 Meow
  和 Miyu 这样的昵称，但它们要么过于可爱，要么显得不太合适。最终，她想到的一个比较合适的昵称是 "Muel"，因为它解决了她在昵称上所遇到的许多问题，并且能与她喜欢的角色相关联。
pubDate: 2023-06-06
tags:
- 御宅訪問
authors:
