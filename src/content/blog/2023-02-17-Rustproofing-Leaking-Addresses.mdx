...
description: 在本文中，作者 nova 详细介绍了如何在 Linux 内核版本 6.1 中利用 Rust 支持来进行内核漏洞利用（Kernel PWN）。文章内容主要涵盖了环境设置、漏洞演示以及修复方法。
pubDate: 2023-02-17
tags:
- Pwn
- Kernel
...
![image-20230217154242780](https://cdn.nova.gal/img/image-20230217154242780.png)
...
![image-20230224132905008](https://cdn.nova.gal/img/image-20230224132905008.png)
...
![image-20230224133211571](https://cdn.nova.gal/img/image-20230224133211571.png)
...
![image-20230224134458315](https://cdn.nova.gal/img/image-20230224134458315.png)
