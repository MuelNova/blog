---
title: 幻兽帕鲁存档结构解析
description: 博主 nova 在文章中详细介绍了将本地存档转换为服务器存档的完整过程。本文假设读者有一定的技术基础，包括使用 Python3 和 terminal，并已经具备开启服务器的能力。
pubDate: 2024-01-23
authors:
- nova
---
...
![image-20240122100541443](https://cdn.nova.gal/img/image-20240122100541443.png)
